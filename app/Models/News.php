...
class News extends Model implements HasMedia, Workflowable
{
    ...
    public function registerMediaCollections(): void
    {
        ...
        /**
         * Фотогалерея материала: несколько снимков, на детальной странице
         * показываются каруселью. Порядок — порядок добавления редактором.
         * Диск тот же, что у обложки: неопубликованный материал не отдаёт
         * и галерею по прямым ссылкам.
         */
        $this->addMediaCollection('gallery')->useDisk($this->contentMediaDisk());
