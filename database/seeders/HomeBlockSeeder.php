...
class HomeBlockSeeder extends Seeder
{
    ...
    {
        $blocks = [
            ['type' => 'active_alerts', 'title' => ['tg' => 'Огоҳиҳо', 'ru' => 'Предупреждения', 'en' => 'Warnings'], 'enabled' => true, 'config' => ['limit' => 3]],
            ['type' => 'latest_news', 'title' => ['tg' => 'Хабарҳои охирин', 'ru' => 'Последние новости', 'en' => 'Latest news'], 'enabled' => true, 'config' => ['limit' => 5]],
            ['type' => 'instructions', 'title' => ['tg' => 'Дастурҳо ба аҳолӣ', 'ru' => 'Инструкции населению', 'en' => 'Public safety guides'], 'enabled' => true, 'config' => ['limit' => 3]],
