...
// Excluded from throttle:api-public — infra health probes must never see a
// 429 from an application-level limit, or a hiccup here could get the
// instance wrongly pulled out of rotation.
...
Route::middleware('throttle:api-public')->group(function (): void {
    ...
    // Real-user Core Web Vitals ingestion (анонимные сэмплы с фронта).
